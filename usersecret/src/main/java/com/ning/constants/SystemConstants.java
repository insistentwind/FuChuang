...
public class SystemConstants {
    ...
    //当前用户与公司不匹配
    public static final String HAS_NO_MATCHED_USER_COMPANY = "此职位对应公司与当前用户不匹配";
    //当前用户没有权限修改此公司
     ...
     * 系统用户管理
     */
    public static final String SYSTEM_USER_ADD = "sys:user:add";
    public static final String SYSTEM_USER_EDIT = "sys:user:edit";
    public static final String SYSTEM_USER_DELETE = "sys:user:delete";

    public static final String SYSTEM_USER_RESET_PWD = "sys:user:reset_pwd";
    /**
     * 角色管理
     */
    public static final String SYSTEM_ROLE_ADD = "sys:role:add";
    public static final String SYSTEM_ROLE_EDIT = "sys:role:edit";
    public static final String SYSTEM_ROLE_DELETE = "sys:role:delete";
    /**
     * 菜单管理
     */
    public static final String SYSTEM_MENU_ADD = "sys:menu:add";
    public static final String SYSTEM_MENU_EDIT = "sys:menu:edit";
    public static final String SYSTEM_MENU_DELETE = "sys:menu:delete";
    /**
     * 公司注册管理
     */
    public static final String SYSTEM_DEPT_ADD = "sys:dept:add";
    public static final String SYSTEM_DEPT_EDIT = "sys:dept:edit";
    public static final String SYSTEM_DEPT_DELETE = "sys:dept:delete";
    /**
     * 日志管理
     */
    public static final String SYSTEM_DICT_ADD = "sys:dict:add";
    public static final String SYSTEM_DICT_EDIT = "sys:dict:edit";
    public static final String SYSTEM_DICT_DELETE = "sys:dict:delete";
     ...
     * 允许查看简历
     */
    public static final Object AGREE_TO_SEE = 1;
